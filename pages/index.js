    ...
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-20 left-10 w-64 h-64 opacity-10 animate-float">
          <div className="hexagon w-full h-full bg-gradient-to-br from-cyan-400 to-cyan-600 animate-morphBlob"></div>
        </div>
        <div className="absolute bottom-20 right-10 w-80 h-80 opacity-10 animate-float" style={{animationDelay: '3s'}}>
          <div className="hexagon w-full h-full bg-gradient-to-br from-orange-400 to-orange-600 animate-morphBlob" style={{animationDelay: '2s'}}></div>
        </div>
        <div className="absolute top-1/2 left-1/3 w-48 h-48 opacity-5 animate-float" style={{animationDelay: '5s'}}>
          <div className="parallelogram w-full h-full bg-gradient-to-br from-blue-400 to-blue-600"></div>
        </div>
        
        {/* Radial gradients for depth */}
        <div className="absolute top-0 left-0 w-96 h-96 bg-cyan-500 rounded-full mix-blend-screen filter blur-[100px] opacity-10 animate-float"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-orange-500 rounded-full mix-blend-screen filter blur-[100px] opacity-10 animate-float" style={{animationDelay: '4s'}}></div>
      </div>
          ...
          <div className="text-center space-y-6 animate-fadeIn">
            ...
            <div className="inline-block mb-4">
              <div className="relative group">
                ...
                <span className="relative px-6 py-3 rounded-full glass-effect text-sm font-bold text-cyan-300 inline-flex items-center gap-2">
            ...
            <div className="relative">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-tight">
                <span className="block gradient-text-cyan drop-shadow-[0_0_30px_rgba(0,212,255,0.3)]">
                  RVCE Grade &
                </span>
                <span className="block gradient-text-orange mt-2 drop-shadow-[0_0_30px_rgba(255,107,53,0.3)]">
                  SGPA Calculator
                </span>
              </h1>
              ...
              <div className="flex items-center justify-center gap-4 mt-6">
                ...
                <div className="w-24 h-1 bg-gradient-to-r from-cyan-400 via-blue-400 to-orange-400 rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="neumorphic rounded-3xl p-8">
            ...
            <div className="flex items-center justify-center gap-8 flex-wrap">
              ...
              >
                <div className="p-2 rounded-lg glass-effect group-hover:shadow-[0_0_20px_rgba(0,212,255,0.3)] transition-all duration-300">
              ...
              >
                <div className="p-2 rounded-lg glass-effect group-hover:shadow-[0_0_20px_rgba(255,107,53,0.3)] transition-all duration-300">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" />
                  </svg>
                </div>
            ...
            <div className="flex justify-center mt-8">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-orange-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                ...
                <form onSubmit={handleReportSubmit}>
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold rounded-xl transition-all transform hover:scale-105 disabled:opacity-50 shadow-[0_0_20px_rgba(0,212,255,0.3)]"
                    >
