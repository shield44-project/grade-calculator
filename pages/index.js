  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        {/* Floating geometric shapes with new colors and animations */}
        <div className="absolute top-20 left-10 w-64 h-64 opacity-15 animate-liquidFloat">
          <div className="hexagon w-full h-full bg-gradient-to-br from-indigo-500 via-purple-500 to-cyan-400 animate-morphBlob"></div>
        </div>
        <div className="absolute bottom-20 right-10 w-80 h-80 opacity-15 animate-liquidFloat" style={{animationDelay: '3s'}}>
          <div className="hexagon w-full h-full bg-gradient-to-br from-amber-400 via-yellow-400 to-orange-500 animate-morphBlob" style={{animationDelay: '2s'}}></div>
        </div>
        <div className="absolute top-1/2 left-1/3 w-48 h-48 opacity-10 animate-float" style={{animationDelay: '5s'}}>
          <div className="parallelogram w-full h-full bg-gradient-to-br from-cyan-400 via-blue-400 to-purple-500 animate-breathe"></div>
        </div>
        <div className="absolute top-1/4 right-1/4 w-56 h-56 opacity-10 animate-float" style={{animationDelay: '7s'}}>
          <div className="w-full h-full rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-500 animate-breathe" style={{animationDelay: '1s'}}></div>
        </div>
          ...
          <div className="text-center space-y-6 animate-fadeIn">
            ...
            <div className="relative">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-tight">
                <span className="block gradient-text-purple drop-shadow-[0_0_40px_rgba(139,92,246,0.5)] animate-slideInUp">
                  RVCE Grade &
                </span>
                <span className="block gradient-text-rainbow mt-2 drop-shadow-[0_0_40px_rgba(251,191,36,0.5)] animate-slideInUp" style={{animationDelay: '0.2s'}}>
                  SGPA Calculator
                </span>
              </h1>
              
              {/* Decorative lines with new colors */}
              <div className="flex items-center justify-center gap-4 mt-6">
                <div className="w-12 h-1 bg-gradient-to-r from-transparent to-purple-400 rounded-full"></div>
                <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>
                <div className="w-24 h-1 bg-gradient-to-r from-indigo-400 via-purple-400 to-cyan-400 rounded-full animate-gradientShift"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="neumorphic rounded-3xl p-8">
            ...
            <div className="flex justify-center mb-8">
              <div className="h-1 w-32 bg-gradient-to-r from-transparent via-purple-400 to-transparent rounded-full animate-gradientShift"></div>
            </div>
            ...
            <div className="flex items-center justify-center gap-8 flex-wrap">
              <a 
                ...
                className="group flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-all duration-300 transform hover:scale-105"
              >
                <div className="p-2 rounded-lg glass-effect group-hover:shadow-[0_0_20px_rgba(139,92,246,0.4)] transition-all duration-300 hover-glow-purple">
            ...
            <div className="flex justify-center mt-8">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/20 via-cyan-500/20 to-indigo-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-gradientShift"></div>
          ...
          <div className="neumorphic rounded-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto animate-scaleIn">
            <div className="p-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold gradient-text-purple">Report an Issue</h2>
                <button
                  onClick={() => {
                    setShowReportModal(false);
                    setReportError('');
              ...
              {reportSuccess ? (
                <div className="py-12 text-center animate-scaleIn">
                  <div className="mb-6 inline-flex items-center justify-center w-20 h-20 rounded-full glass-effect-purple animate-rainbowPulse">
                    <svg className="w-10 h-10 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  <p className="text-purple-400 text-xl font-bold mb-2">Issue reported successfully!</p>
                ...
                <form onSubmit={handleReportSubmit}>
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 neumorphic-inset rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-white transition-all"
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 neumorphic-inset rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 text-white resize-none transition-all"
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      className="flex-1 px-6 py-3 bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500 hover:from-indigo-600 hover:via-purple-600 hover:to-cyan-600 text-white font-bold rounded-xl transition-all transform hover:scale-105 disabled:opacity-50 shadow-[0_0_20px_rgba(139,92,246,0.4)] animate-gradientShift"
                    >
