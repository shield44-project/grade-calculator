...
export const courses = [
  ...
  { code: 'MA211TC', title: 'Fundamentals of Linear Algebra, Calculus and Statistics', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'ME112GL', title: 'Computer Aided Engineering Graphics', credits: 3, type: 'Lab', cieMax: 50, seeMax: 50 },
  ...
  { code: 'HS111EL', title: 'Communicative English-I', credits: 1, type: 'Lab', cieMax: 50, seeMax: 50 },
  { code: 'HS114TC', title: 'Fundamentals of Indian Constitution', credits: 1, type: 'Theory', cieMax: 50, seeMax: 50 },
  { code: 'HS115YL', title: 'Scientific Foundations of Health-Yoga Practice', credits: 1, type: 'Lab', cieMax: 50, seeMax: 50 },

  // SEM II - PHYSICS CYCLE (CS, BT, CD, CY, CI) - Page 7
  { code: 'MA221TC', title: 'Number Theory, Vector Calculus and Computational Methods', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'HS121EL', title: 'Communicative English-II', credits: 1, type: 'Lab', cieMax: 50, seeMax: 50 },
  { code: 'HS12XKB', title: 'Samskrutika Kannada/ Balake Kannada', credits: 1, type: 'Theory', cieMax: 50, seeMax: 50 },
  { code: 'ME121DL', title: 'IDEA LAB', credits: 1, type: 'Lab', cieMax: 50, seeMax: 50 },
  
  // SEM I - PHYSICS CYCLE (EC, EE, ET) - Page 8
  { code: 'MA211TA', title: 'Fundamentals of Linear Algebra, Calculus and Numerical Methods', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'MA221TA', title: 'Vector Calculus, Laplace Transform and Numerical Methods', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'ME122GL', title: 'Computer Aided Engineering Graphics', credits: 3, type: 'Lab', cieMax: 50, seeMax: 50 },
  
  // SEM I - PHYSICS CYCLE (AS, CH, IM, ME) - Page 9
  { code: 'MA211TB', title: 'Fundamentals of Linear Algebra, Calculus and Differential Equations', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'MA221TB', title: 'Vector Calculus and Computational Methods', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'MA211TD', title: 'Applied Mathematics – I', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
  ...
  { code: 'MA221TD', title: 'Applied Mathematics – II', credits: 4, type: 'Theory', cieMax: 100, seeMax: 100 },
