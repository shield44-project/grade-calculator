    ...
    <div className="w-full mx-auto animate-fadeIn">
      ...
      <div className="sticky top-4 z-20 mb-12">
        <div className="relative overflow-hidden rounded-3xl animate-scaleIn">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-indigo-500 via-purple-500 to-cyan-500 opacity-30 blur-xl animate-pulse"></div>
          ...
          <div className="relative neumorphic p-8 sm:p-10">
            {cgpa ? (
              ...
              <div className="space-y-8">
                {/* CGPA Display */}
                <div className="flex flex-col md:flex-row justify-between items-center gap-8 pb-8 border-b border-purple-500/20">
                  <div className="text-center md:text-left">
                    <div className="text-purple-400 text-sm font-bold uppercase tracking-wider mb-2 flex items-center gap-2">
                      <div className="w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>
                      Your Overall
                    </div>
                    <h2 className="text-4xl font-black gradient-text-purple">CGPA Score</h2>
                  </div>
                  
                  <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full blur-2xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
                    <div className="relative neumorphic-inset rounded-full p-10 border-4 border-purple-500/30">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                ...
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-cyan-500 to-indigo-500 rounded-full blur-2xl opacity-50 group-hover:opacity-75 transition-opacity"></div>
